package com.gedhafu.countrypicker.util
...
class PhoneNumberTransformation(
    country_code: String = Locale.getDefault().country
) : VisualTransformation {

    private val formatter = PhoneNumberUtil.getInstance().getAsYouTypeFormatter(country_code)
